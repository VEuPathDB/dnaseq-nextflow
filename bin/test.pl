...
while ($i <= $greatestLocation) {
  ...
  if ($i == $greatestLocation) {
      print "CacheFileline going in  = $cacheFileLine snpFileLine going in = $snpFileLine\n";
  }
  ...
  if ($i == $greatestLocation) {
      ...
      print "CacheFileline = $cacheFileLine snpFileLine = $snpFileLine\n";
      die;
  }
  
  $i = $i == $greatestLocation ? $i + 1 : $i;
